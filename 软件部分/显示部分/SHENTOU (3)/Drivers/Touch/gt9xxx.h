...
#define GT9XXX_RST_GPIO_PORT            GPIOA
#define GT9XXX_RST_GPIO_PIN             GPIO_PIN_4
#define GT9XXX_RST_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PF口时钟使能 */

#define GT9XXX_INT_GPIO_PORT            GPIOC
#define GT9XXX_INT_GPIO_PIN             GPIO_PIN_1
#define GT9XXX_INT_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* PF口时钟使能 */
